...
export const DICTIONARY_TABLE_HEADERS = ["Word", "Translation", "Progress", ""];
export const RECOMMEND_TABLE_HEADERS = ["Word", "Translation", "Category", ""];